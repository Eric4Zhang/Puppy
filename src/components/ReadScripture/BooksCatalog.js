...
export default function BooksCatalog(){
    const oldTestament = [
        ...
        {'fullName': '申命記', 'abbr' :'申', 'chapter': '34', "id": "deut"},
        {'fullName': '約書亞記', 'abbr' :'書', 'chapter': '24', "id": "josh"},
        {'fullName': '士師記', 'abbr' :'士', 'chapter': '21', "id": "judg"},
        ...
        {'fullName': '歷代志上', 'abbr' :'代上', 'chapter': '29', "id": "1chron"},
        {'fullName': '歷代志下', 'abbr' :'代下', 'chapter': '36', "id": "2chron"},
        ...
        {'fullName': '箴言', 'abbr' :'箴', 'chapter': '31', "id": "prov"},
        {'fullName': '傳道書', 'abbr' :'傳', 'chapter': '12', "id": "eccl"},
        {'fullName': '雅歌', 'abbr' :'歌', 'chapter': '8', "id": "song of sol"},
        {'fullName': '以賽亞書', 'abbr' :'賽', 'chapter': '66', "id": "isa"},
        {'fullName': '耶利米書', 'abbr' :'耶', 'chapter': '52', "id": "jer"},
        {'fullName': '耶利米哀歌', 'abbr' :'哀', 'chapter': '5', "id": "lam"},
        {'fullName': '以西結書', 'abbr' :'結', 'chapter': '48', "id": "ezek"},
